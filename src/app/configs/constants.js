...
export const BOTTLE_UPLOADED = 'Bottle successfully uploaded.';
export const UNCOMPLETED_BOTTLE_DATA = 'Not all the descriptions are completed.';

export const FACEBOOK_USER_ADDED = 'Facebook User successfully registered.';
